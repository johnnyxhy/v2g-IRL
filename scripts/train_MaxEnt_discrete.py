...
dataset.load_trajectories_from_json("data/processed_trajectories_discrete_profit.json")
...
if __name__ == "__main__":
    ...
    cfg.policy_train_steps_per_iter = 1_000_000
    cfg.policy_n_steps = 2048
    cfg.policy_n_epochs = 10
    cfg.policy_ent_coef = 0.01
    cfg.folder_name = "MaxEntIRL_discrete_profit_exp2"
    cfg.validation = True
    cfg.reset_ppo_each_epoch = True
    cfg.reg_lambda = 0.01
    cfg.description = "20 epochs, 1,000,000 PPO steps, PPO reset, 0.01 boundary penalty, 0.01 l2 reg, 0.01 lr"
