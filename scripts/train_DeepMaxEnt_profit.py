...
import numpy as np
import torch
from irl.DeepMaxEnt.DeepMaxEnt_profit import DeepMaxEntConfig, DeepMaxEntIRLTrainer, load_deep_expert_data
import warnings
...
if __name__ == "__main__":
    # Load expert data (run expert_loader_deep_profit.py first to generate the JSON)
